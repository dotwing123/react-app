...
const SaveData = () => {
  ...
  useEffect(() => {
    secureLocalStorage.setItem("nearByShops", JSON.stringify(nearByShops));
    secureLocalStorage.setItem("cuisines", JSON.stringify(cuisines));
    secureLocalStorage.setItem("cuisinesList", JSON.stringify(cuisinesList));
    secureLocalStorage.setItem("foods", JSON.stringify(foods));
    secureLocalStorage.setItem(
      "chefDetailsFoodList",
      JSON.stringify(chefDetailsFoodList)
    );
    dispatch(setChefs(nearByShops));
    dispatch(setCuisines(cuisines));
    dispatch(setCuisinesList(cuisinesList));
